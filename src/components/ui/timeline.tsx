  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 pb-20 md:px-8 lg:px-10">
        ...
        >
          Processo estruturado e comprovado que garante a entrega de soluções
          tecnológicas de alta qualidade, alinhadas aos objetivos estratégicos
          do seu negócio.
        </p>
      </div>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              ...
              <h3 className="hidden text-xl font-bold text-neutral-500 dark:text-white md:block md:pl-20 md:text-5xl">
                {item.title}
              </h3>
            </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-blue-500 from-[0%] via-green-500 via-[10%] to-transparent"
          />
        </div>
      </div>
    </section>
